...
(function ($, global, undefined) {
            ...
            menuItems: [
                {
                    ...
                    subMenu: [
                        {
                            name: "Create",
                            displayName: "Create File Share inside123",
                            ...
                            subMenu: [
                                {
                                    ...
                                    template: "CreateFileShare",
                                    ok: function (object) {
                                      console.log('ok clicked inside quick create...');
                                      return false;
                                    }
                                }
                            ]
    ...
    function getQuickCreateFileShareMenuItem() {
        return {
            name: "QuickCreate",
            displayName: "Create File Share outside123",
            ...
            ok: function (object) {
              console.log('ok clicked outside quick create...');
